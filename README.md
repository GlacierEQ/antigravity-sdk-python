...
```yaml
{
  ...
  "repository": {
    "id": "GlacierEQ/antigravity-sdk-python",
    "url": "https://github.com/GlacierEQ/antigravity-sdk-python",
    "readme_contract": "estate-machine-v1",
    "default_branch": "main"
  },
  "machine": {
    "repository_kind": "fork-or-derived-source",
  ...
  "license": {
    ...
    "status": "UPSTREAM_LICENSE_PRESENT_REVIEW_REQUIRED",
  ...
  "provenance": {
    ...
    "contract_digest": "4dc2960ff33263e94dc99b41f4091bb6df7988919184483656af6b8b5996a015"
  }
}
```
